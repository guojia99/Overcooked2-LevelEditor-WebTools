import{U as S,V as U}from"./version-DbhnSXba.js";import{fetchTemplateMeshBuffer as z,previewLocalModel as D}from"./recipeModelPreview-CFteY4EO.js";import"./main-CgY3UP_x.js";const a=1024,M="#c06205";function R(l){return String(l??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function F(l){const s=l.toDataURL("image/png"),o=s.indexOf(",");return o>=0?s.slice(o+1):s}function $(l,s){return new Promise((o,i)=>{l.toBlob(t=>{if(!t){i(new Error("贴图导出失败。"));return}o(new File([t],s,{type:"image/png"}))},"image/png")})}function X(l){var f,b,y,E,h,w,I,L;const s=l.templateId??"FriedFishCake";let o=l.initialColor??M;S("🎨 夹心贴图编辑器",`<p class="modal-hint">产出一张 ${a}×${a} PNG 贴图，贴到模板网格
      <code>${R(s)}.fbx</code> 上。纯色即可用（官方夹心贴图本身就是纯色）；
     ...
     <div class="tex-editor">
       ...
       <div class="tex-tools">
         <div class="tex-row"><span class="muted">主色</span>
           <input type="color" id="tex-color" value="${R(o)}">
