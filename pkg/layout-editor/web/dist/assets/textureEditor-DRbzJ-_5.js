import{L as S,N as R}from"./version-B4SLCRI5.js";import{fetchTemplateMeshBuffer as z,previewLocalModel as D}from"./recipeModelPreview-K1pllHFw.js";const a=1024,M="#c06205";function U(l){return String(l??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function F(l){const s=l.toDataURL("image/png"),o=s.indexOf(",");return o>=0?s.slice(o+1):s}function $(l,s){return new Promise((o,i)=>{l.toBlob(t=>{if(!t){i(new Error("贴图导出失败。"));return}o(new File([t],s,{type:"image/png"}))},"image/png")})}function G(l){var f,b,y,E,h,w,L,I;const s=l.templateId??"FriedFishCake";let o=l.initialColor??M;S("🎨 夹心贴图编辑器",`<p class="modal-hint">产出一张 ${a}×${a} PNG 贴图，贴到模板网格
