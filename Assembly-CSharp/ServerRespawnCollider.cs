...
public class ServerRespawnCollider : ServerSynchroniserBase
{
	...
	{
		if (!(m_RespawnCollider == null) && (m_RespawnCollider.m_respawnFilter.value & (1 << _gameObject.layer)) != 0 && (!m_RespawnCollider.m_onlyRespawnables || _gameObject.RequestInterfaceRecursive<IRespawnBehaviour>() != null))
		{
