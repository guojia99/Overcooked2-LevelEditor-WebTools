...
namespace GameModes.Horde
{
	public class ClientHordeFlowController : ClientFlowControllerBase, IRecipeListCache
	{
		...
		public void RegisterOnSuccessfulDelivery(object handle, ClientHordeTarget target, GenericVoid<RecipeList.Entry> onSuccessfulDelivery)
		{
			...
			int num2;
			(onSuccessfulDeliveryForTarget = m_onSuccessfulDeliveryForTarget)[num2 = num] = (GenericVoid<RecipeList.Entry>)Delegate.Combine(onSuccessfulDeliveryForTarget[num2], onSuccessfulDelivery);
		}
		...
		public void UnregisterOnSuccessfulDelivery(object handle, ClientHordeTarget target, GenericVoid<RecipeList.Entry> onSuccessfulDelivery)
		{
			...
			GenericVoid<RecipeList.Entry>[] onSuccessfulDeliveryForTarget;
			int num2;
			(onSuccessfulDeliveryForTarget = m_onSuccessfulDeliveryForTarget)[num2 = num] = (GenericVoid<RecipeList.Entry>)Delegate.Remove(onSuccessfulDeliveryForTarget[num2], onSuccessfulDelivery);
		}
		...
		public void RegisterOnIncorrectDelivery(object handle, ClientHordeTarget target, GenericVoid<RecipeList.Entry> onIncorrectDelivery)
		{
			...
			int num2;
			(onIncorrectDeliveryForTarget = m_onIncorrectDeliveryForTarget)[num2 = num] = (GenericVoid<RecipeList.Entry>)Delegate.Combine(onIncorrectDeliveryForTarget[num2], onIncorrectDelivery);
		}
		...
		public void UnregisterOnIncorrectDelivery(object handle, ClientHordeTarget target, GenericVoid<RecipeList.Entry> onIncorrectDelivery)
		{
			...
			GenericVoid<RecipeList.Entry>[] onIncorrectDeliveryForTarget;
			int num2;
			(onIncorrectDeliveryForTarget = m_onIncorrectDeliveryForTarget)[num2 = num] = (GenericVoid<RecipeList.Entry>)Delegate.Remove(onIncorrectDeliveryForTarget[num2], onIncorrectDelivery);
		}
		...
		public void RegisterOnEntryAdded(object handle, ClientHordeTarget target, GenericVoid<RecipeList.Entry> onOrderChanged)
		{
			...
			int num2;
			(onEntryAddedForTarget = m_onEntryAddedForTarget)[num2 = num] = (GenericVoid<RecipeList.Entry>)Delegate.Combine(onEntryAddedForTarget[num2], onOrderChanged);
		}
		...
		public void UnregisterOnEntryAdded(object handle, ClientHordeTarget target, GenericVoid<RecipeList.Entry> onOrderChanged)
		{
			...
			GenericVoid<RecipeList.Entry>[] onEntryAddedForTarget;
			int num2;
			(onEntryAddedForTarget = m_onEntryAddedForTarget)[num2 = num] = (GenericVoid<RecipeList.Entry>)Delegate.Remove(onEntryAddedForTarget[num2], onOrderChanged);
		}
		...
		public void RegisterOnEnemyApproaching(object handle, ClientHordeTarget target, GenericVoid<ClientHordeEnemy> onEnemyApproaching)
		{
			...
			int num2;
			(onEnemyApproachingTarget = m_onEnemyApproachingTarget)[num2 = num] = (GenericVoid<ClientHordeEnemy>)Delegate.Combine(onEnemyApproachingTarget[num2], onEnemyApproaching);
		}
		...
		public void UnregisterOnEnemyApproaching(object handle, ClientHordeTarget target, GenericVoid<ClientHordeEnemy> onEnemyApproaching)
		{
			...
			GenericVoid<ClientHordeEnemy>[] onEnemyApproachingTarget;
			int num2;
			(onEnemyApproachingTarget = m_onEnemyApproachingTarget)[num2 = num] = (GenericVoid<ClientHordeEnemy>)Delegate.Remove(onEnemyApproachingTarget[num2], onEnemyApproaching);
		}
		...
		public void RegisterOnEnemyDespawning(object handle, ClientHordeTarget target, GenericVoid<ClientHordeEnemy> onEnemyDespawning)
		{
			...
			int num2;
			(onEnemyDespawningForTarget = m_onEnemyDespawningForTarget)[num2 = num] = (GenericVoid<ClientHordeEnemy>)Delegate.Combine(onEnemyDespawningForTarget[num2], onEnemyDespawning);
		}
		...
		public void UnregisterOnEnemyDeath(object handle, ClientHordeTarget target, GenericVoid<ClientHordeEnemy> onEnemyDespawning)
		{
			...
			GenericVoid<ClientHordeEnemy>[] onEnemyDespawningForTarget;
			int num2;
			(onEnemyDespawningForTarget = m_onEnemyDespawningForTarget)[num2 = num] = (GenericVoid<ClientHordeEnemy>)Delegate.Remove(onEnemyDespawningForTarget[num2], onEnemyDespawning);
		}
