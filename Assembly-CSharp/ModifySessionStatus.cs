public class ModifySessionStatus : BaseStatus
{
	public override string GetLocalisedProgressDescription()
	{
		...
		case eConnectionModeSwitchProgress.InProgress:
			return Localization.Get("Online.ConnectionMode.ModifySession.InProgress");
	...
	{
		ModifySessionStatus modifySessionStatus = new ModifySessionStatus();
		modifySessionStatus.Result = Result;
		modifySessionStatus.Progress = Progress;
		return modifySessionStatus;
	}
}
