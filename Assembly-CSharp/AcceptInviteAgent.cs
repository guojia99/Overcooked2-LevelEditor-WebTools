...
public class AcceptInviteAgent : ConnectionModeAgent
{
	...
	public virtual bool Start(Server server, Client client, object data, GenericVoid<IConnectionModeSwitchStatus> callback)
	{
		...
		m_LocalServer.Reset();
		m_LocalClient.Reset();
		PrivilegeCheckAllUsersForInviteTask privilegeCheckAllUsersForInviteTask = m_Tasks[1] as PrivilegeCheckAllUsersForInviteTask;
		privilegeCheckAllUsersForInviteTask.Initialise();
		AcceptInviteTask acceptInviteTask = m_Tasks[2] as AcceptInviteTask;
