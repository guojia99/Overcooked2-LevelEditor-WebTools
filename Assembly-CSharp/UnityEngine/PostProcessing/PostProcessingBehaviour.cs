...
namespace UnityEngine.PostProcessing
{
	...
	public class PostProcessingBehaviour : MonoBehaviour
	{
		...
		private TiltShiftComponent m_TiltShift;
		...
		private void OnEnable()
		{
			...
			m_TiltShift = AddComponent(new TiltShiftComponent());
			m_ComponentStates = new Dictionary<PostProcessingComponentBase, bool>();
			for (int i = 0; i < m_Components.Count; i++)
			{
				PostProcessingComponentBase key = m_Components[i];
		...
		private void OnPreCull()
		{
			...
			m_TiltShift.Init(postProcessingContext, profile.tiltshift);
			...
			for (int i = 0; i < m_Components.Count; i++)
			{
				PostProcessingComponentBase postProcessingComponentBase = m_Components[i];
		...
		private void OnPreRender()
		{
			if (!(profile == null))
			{
				...
				TryExecuteCommandBuffer(m_TiltShift);
