namespace InControl
{
	...
	public class PlayStation3LinuxProfile : UnityInputDeviceProfile
	{
		public PlayStation3LinuxProfile()
		{
			...
			base.SupportedPlatforms = new string[1] { "Linux" };
			JoystickNames = new string[2] { "Sony PLAYSTATION(R)3 Controller", "SHENGHIC 2009/0708ZXW-V1Inc. PLAYSTATION(R)3Conteroller" };
