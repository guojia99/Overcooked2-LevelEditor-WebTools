...
namespace InControl
{
	public struct KeyInfo
	{
		...
		public static readonly KeyInfo[] KeyList = new KeyInfo[114]
		{
			...
			new KeyInfo(Key.Mouse0, "Mouse 0", KeyCode.Mouse0),
			new KeyInfo(Key.Mouse1, "Mouse 1", KeyCode.Mouse1),
			new KeyInfo(Key.Mouse2, "Mouse 2", KeyCode.Mouse2),
			new KeyInfo(Key.Mouse3, "Mouse 3", KeyCode.Mouse3),
			new KeyInfo(Key.Mouse4, "Mouse 4", KeyCode.Mouse4)
		};
