namespace InControl
{
	...
	public class PlayStation3MacProfile : UnityInputDeviceProfile
	{
		public PlayStation3MacProfile()
		{
			...
			base.SupportedPlatforms = new string[1] { "OS X" };
			JoystickNames = new string[4] { "Sony PLAYSTATION(R)3 Controller", "SHENGHIC 2009/0708ZXW-V1Inc. PLAYSTATION(R)3Conteroller", "SZMY-POWER CO.,LTD. GAMEPAD 3 TURBO", "Gasia Co.,Ltd PS(R) Gamepad" };
