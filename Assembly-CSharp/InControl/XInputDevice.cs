...
namespace InControl
{
	public class XInputDevice : InputDevice
	{
			...
			: base("XInput Controller")
		{
			...
			AddControl(InputControlType.LeftStickLeft, "Left Stick Left", 0.4f, 0.9f);
			AddControl(InputControlType.LeftStickRight, "Left Stick Right", 0.4f, 0.9f);
			AddControl(InputControlType.LeftStickUp, "Left Stick Up", 0.4f, 0.9f);
			AddControl(InputControlType.LeftStickDown, "Left Stick Down", 0.4f, 0.9f);
			AddControl(InputControlType.RightStickLeft, "Right Stick Left", 0.4f, 0.9f);
			AddControl(InputControlType.RightStickRight, "Right Stick Right", 0.4f, 0.9f);
			AddControl(InputControlType.RightStickUp, "Right Stick Up", 0.4f, 0.9f);
			AddControl(InputControlType.RightStickDown, "Right Stick Down", 0.4f, 0.9f);
			AddControl(InputControlType.LeftTrigger, "Left Trigger", 0.4f, 0.9f);
			AddControl(InputControlType.RightTrigger, "Right Trigger", 0.4f, 0.9f);
			AddControl(InputControlType.DPadUp, "DPad Up", 0.4f, 0.9f);
			AddControl(InputControlType.DPadDown, "DPad Down", 0.4f, 0.9f);
			AddControl(InputControlType.DPadLeft, "DPad Left", 0.4f, 0.9f);
			AddControl(InputControlType.DPadRight, "DPad Right", 0.4f, 0.9f);
