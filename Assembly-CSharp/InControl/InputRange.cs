...
namespace InControl
{
	public struct InputRange
	{
		...
		private static readonly InputRange[] TypeToRange = new InputRange[7] { None, MinusOneToOne, ZeroToOne, ZeroToMinusOne, ZeroToNegativeInfinity, ZeroToPositiveInfinity, Everything };
