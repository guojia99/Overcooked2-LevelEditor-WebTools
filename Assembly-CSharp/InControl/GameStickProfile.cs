namespace InControl
{
	...
	public class GameStickProfile : UnityInputDeviceProfile
	{
		public GameStickProfile()
		{
			...
			base.SupportedPlatforms = new string[1] { "GameStick" };
			JoystickNames = new string[4] { "GameStick Controller 1", "GameStick Controller 2", "GameStick Controller 3", "GameStick Controller 4" };
